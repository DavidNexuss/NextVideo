CC=g++
CFLAGS= -g -I src -I libDist/assimp/include -I libDist/glfw/include -I libDist/glew-2.2.0/include -I lib/glm -I lib/imgui
LDFLAGS= -lGL
...
bin/fdm: obj/glfwSurface.o obj/gl.o obj/util.o src/tests/fdm.cpp libDist/imgui/imgui.a $(LIBS)  libDist/imgui/imgui.a libDist/imgui/imgui_impl_opengl3.o libDist/imgui/imgui_impl_glfw.o
	$(CC) $(CFLAGS) $(LDFLAGS) $^ -o $@ #  -sUSE_GLFW=3
